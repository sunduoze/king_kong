...
ad7124_st_reg ad7124_regs[] =
{
    ...
    {0x01, 0x0080, 2, 1}, /* AD7124_ADC_Control */
    ...
    {0x09, 0x8001, 2, 1}, /* AD7124_Channel_0 *///1000 0000 0000 0001
    {0x0A, 0x8043, 2, 1}, /* AD7124_Channel_1 *///1001 0000 0100 0011
    {0x0B, 0x8085, 2, 1}, /* AD7124_Channel_2 *///1010 0000 1000 0101
    {0x0C, 0x0001, 2, 1}, /* AD7124_Channel_3 *///1011 0000 1100 0111 //0xB0C7
    ...
    {0x1A, 0x09f0, 2, 1}, /* AD7124_Config_1 */
    {0x1B, 0x09f0, 2, 1}, /* AD7124_Config_2 */
    {0x1C, 0x09f0, 2, 1}, /* AD7124_Config_3 */
    ...
    {0x21, 0xED0000, 3, 1}, /* AD7124_Filter_0 *///0x060030
    {0x22, 0xED0000, 3, 1}, /* AD7124_Filter_1 */
    {0x23, 0xED0000, 3, 1}, /* AD7124_Filter_2 */
    {0x24, 0xED0000, 3, 1}, /* AD7124_Filter_3 */
