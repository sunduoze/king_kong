 ...
 * Author: Enzo
 */
#ifndef BSP_CAT9555_1_H_
#define BSP_CAT9555_1_H_
...
/*函数*/
extern void CAT9555_1_INIT(void);
...
extern void CAT9555_1_RelayBoard_AllRelay_DIS(void);
extern void CAT9555_1_RelayBoard_AllRelay_EN(void);
extern void CAT9555_1_ReadTestPoint(uint16_t ReadData,uint8_t ControlBit);
extern void CAT9555_1_WriteOneBit(uint8_t Address, uint8_t BitNum16, uint8_t WriteDate);
extern void CAT9555_1_WriteTwoByte(uint8_t Address, uint16_t WriteDate);
